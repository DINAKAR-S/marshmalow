const ids = [];
        ...
        img4 : "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRjNl4jxcFqnAt99VlOi7w5nPxRIi86ZyPJrfZPvsLQcBLv1kRf7NpxpSvf7bF0T7WhUMo&usqp=CAU",
        ...
        function randomizationOfImg() {
            ...
            const  cboxes = document.querySelectorAll('#container2 img');
        ...
        function getbox() {
            const btn = document.getElementById('btn');
            const reset = document.getElementById('reset');
            const  boxes = document.querySelectorAll('#container2 img');
            let prevId = 420;
